...
/*#__PURE__*/
function (_Effect) {
  _inherits(HardFlickering, _Effect);
  ...
  function HardFlickering(invoker, config) {
    ...
    _this = _possibleConstructorReturn(this, (HardFlickering.__proto__ || Object.getPrototypeOf(HardFlickering)).call(this, invoker, config));
...
function (_WorldItem) {
  ...
  function LightSource(room, x, y, texture, layer, graphicLightConfig, diffusedLightConfig, offset, allowedBehaviours) {
    ...
    _this.room.lightSources.add(_this); // this.lightBehaviour = new LightSourceBehaviourComponent(this, allowedBehaviours);
